...
class TESTE2MATA010(unittest.TestCase):
	...
	def setUpClass(inst):
		inst.oHelper = Webapp()
		inst.oHelper.Setup("SIGACOM","20/08/2025","01","01011001","02")
		
	def test_TESTE2MATA010_001(self):

		descricao = "TESTE PRODUTO TIR V3"
		
		self.oHelper.Program("MATA010")
		self.oHelper.SetButton("Incluir")
		self.oHelper.WaitShow("Atualizacao de Produtos - Incluir", 20)
		#self.oHelper.WaitFieldValue("B1_DESC", "TESTE PRODUTO TIR V3")
		self.oHelper.SetFocus("B1_DESC") #Foco no Campo Descrição
		self.oHelper.SetValue("B1_DESC", "")
		self.oHelper.SetKey('Backspace')
		self.oHelper.SetValue("B1_DESC", descricao)
		self.oHelper.CheckHelp(text_help="Descricao", button = "Fechar")
		self.oHelper.SetValue("B1_UM","UN")
		self.oHelper.SetValue("B1_XAPRES","")
		self.oHelper.SetValue("B1_XMARCA","")
		...
		self.oHelper.SetValue("B1_XSKU","07280000025589")
		...
		self.oHelper.SetValue("B1_COD","25590")
		self.oHelper.SetValue("B1_MSBLQL", "2 - Não")
		self.oHelper.SetValue("B1_XCODANT","")
